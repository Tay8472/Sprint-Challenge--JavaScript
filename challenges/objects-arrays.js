...
const unisWithUni = graduates.filter((uniOnly) => uniOnly.university.includes('Uni'));
...
const lowCaseAnimalNames = zooAnimals.map((ani) => {
...
*/
// const populationTotal = zooAnimals.reduce((collector, item) => collector + item.population);
